...
program: block              { astOutput = $1; astPrint($1, 0); checkAndSetDeclarations($1); checkUndeclared(); checkOperands($1); $$ = $1; }
         | listDeclarations { astOutput = $1; astPrint($1, 0); checkAndSetDeclarations($1); checkUndeclared(); checkOperands($1); $$ = $1; }
         ;
